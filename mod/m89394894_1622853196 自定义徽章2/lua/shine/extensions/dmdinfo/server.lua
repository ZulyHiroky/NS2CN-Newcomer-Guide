...
Plugin.ConfigName = "dmdinfo.json" --What's the name of the file?
...
function Plugin.ShowDmdInfo( Client )
...
function Plugin:CreateCommands()
     self:BindCommand( "sh_dmdinfo", "dmdinfo", Plugin.ShowDmdInfo, true )
         :Help( "Shows dmd info" )
end
